...
public class SeoulClockPane extends ClockPane {

	double clockRadius;
	double centerX;
	double centerY;
	
	public SeoulClockPane() {
		if(this.hour>=12) this.setBackground(new Background(new BackgroundFill(Color.BLACK, CornerRadii.EMPTY, Insets.EMPTY)));
		else this.setBackground(new Background(new BackgroundFill(Color.WHITE, CornerRadii.EMPTY, Insets.EMPTY)));
	}
	...
	protected void paintClock() {
		...
		// Draw Name of Clock
		Text clockName = new Text(centerX-clockRadius*0.32, centerY+clockRadius*0.6, "Seoul");
